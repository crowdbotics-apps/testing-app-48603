"""
Django settings for testing_app_48603 project.
...
ROOT_URLCONF = 'testing_app_48603.urls'
...
WSGI_APPLICATION = 'testing_app_48603.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "testing-app Support <support@testing-app-48603.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testing_app_48603 API",
    "DESCRIPTION": "API documentation for testing_app_48603 App",
    "VERSION": "v1",
}
